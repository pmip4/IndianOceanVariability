...
function hasSSTvars {
  ...
  hasSSTvars_nino34_vars=`ncdump -h $hasSSTvars_DIR/$hasSSTvars_filename | grep float | grep nino34 | cut -d\( -f1 | cut -d\  -f2`
  if [[ $hasSSTvars_nino34_vars == *"nino34_spacomp_pr_djf1"* ]] && [[ $hasSSTvars_nino34_vars == *"nino34_spacomp_tas_djf1"* ]] && [[ $hasSSTvars_nino34_vars == *"nino34_spacomp_sst_djf1"* ]]
  then
    return 1
  else
    return 0
...
function hasTASvars {
  ...
  hasPPTvars_nino34_vars=`ncdump -h $hasPPTvars_DIR/$hasPPTvars_filename | grep float | grep tas | cut -d\( -f1 | cut -d\  -f2`
...
function hasPRvars {
  ...
  hasPRvars_nino34_vars=`ncdump -h $hasPRvars_DIR/$hasPRvars_filename | grep float | grep pr | cut -d\( -f1 | cut -d\  -f2`
...
do
  ...
  hasSSTvars $CVDP_DATA_DIR $ncfile
  if [ $? == 1 ]; then
...
pr_spatialstddev_ann,pr_spatialstddev_djf,pr_spatialstddev_jja,pr_spatialstddev_mam,pr_spatialstddev_son \
  $CVDP_DATA_DIR/GPCP.cvdp_data.1979-2019.nc GPCP.cvdp_SST.1979-2019.nc
...
nino34_spectra,nino34_wavelet_power,nino34_wavelet_significance,nino4 \
  $CVDP_DATA_DIR/HadISST.cvdp_data.1870-2016.nc HadISST.cvdp_SST.1870-2016.nc
ncks -A -v nino34_spacomp_sst_djf1,nino34_spacomp_sst_jja0,nino34_spacomp_sst_mam1,nino34_spacomp_sst_son0 \
  $CVDP_DATA_DIR/C20-Reanalysis.cvdp_data.1871-2012.nc HadISST.cvdp_SST.1870-2016.nc
ncap2 -A -s 'nino34_spacomp_sst_ann=0.25f*(nino34_spacomp_sst_jja0+nino34_spacomp_sst_son0+nino34_spacomp_sst_djf1+nino34_spacomp_sst_mam1)' \
  HadISST.cvdp_SST.1870-2016.nc HadISST.cvdp_SST.1870-2016.nc

ncks -O -v sst_spatialmean_ann,sst_spatialmean_son,sst_spatialstddev_ann,sst_spatialstddev_son,\
pr_spatialmean_ann,pr_spatialmean_son,pr_spatialstddev_ann,pr_spatialstddev_jja,\
tas_spatialmean_ann,tas_spatialmean_son,tas_spatialstddev_ann,tas_spatialstddev_son,\
nino34,eeio,tio,iod,\
...
nino34_spacomp_lanina_tas_jja0,nino34_spacomp_lanina_tas_mam1,nino34_spacomp_lanina_tas_son0 \
  $CVDP_DATA_DIR/C20-Reanalysis.cvdp_data.1871-2012.nc C20-Reanalysis.cvdp_SST.1871-2012.nc
ncap2 -A -s 'nino34_spacomp_sst_ann=0.25f*(nino34_spacomp_sst_jja0+nino34_spacomp_sst_son0+nino34_spacomp_sst_djf1+nino34_spacomp_sst_mam1)' \
  C20-Reanalysis.cvdp_SST.1871-2012.nc C20-Reanalysis.cvdp_SST.1871-2012.nc
